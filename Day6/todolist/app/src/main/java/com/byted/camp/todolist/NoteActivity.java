...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content, Priority priority) {
        if (database == null || content == null) {
            return false;
        }

        ContentValues values = new ContentValues();
        values.put(TodoNote.attr_content, content);
        values.put(TodoNote.attr_state, State.TODO.intValue);
        values.put(TodoNote.attr_date, System.currentTimeMillis());
        values.put(TodoNote.attr_priority, priority.intValue);
